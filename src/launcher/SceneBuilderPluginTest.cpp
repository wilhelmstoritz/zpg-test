...
void SceneBuilderPluginTest::createLights() {
    ...
    light = this->m_lightWarehouse->createLight("test::light01", Light::LightTypeE::POINT, glm::vec3(0.f, 40.f, 0.f));
...
void SceneBuilderPluginTest::postProcess() {
    ...
    this->m_scene->getCamera()->setPosition(
        glm::vec3(Config::SKYBOX_XCENTER, Config::SKYBOX_YCENTER, Config::SKYBOX_ZCENTER + 20.f),
