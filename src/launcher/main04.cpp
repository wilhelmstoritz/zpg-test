...
const char* vertex_shader04 = // renamed due to variable name collision; original variable name: vertex_shader
"#version 330\n"
...
const char* fragment_shader04 = // renamed due to variable name collision; original variable name: fragment_shader
"#version 330\n"
"in vec3 worldNormal;"
...
int main04(void)
{
	...
	glShaderSource(vertexShader, 1, &vertex_shader04, NULL);
	glCompileShader(vertexShader);
	GLuint fragmentShader = glCreateShader(GL_FRAGMENT_SHADER);
	glShaderSource(fragmentShader, 1, &fragment_shader04, NULL);
	...
	{
		alpha += 0.01f; // corrected (conversion double/float); original version: alpha += 0.01;
