...
void SceneBuilderPlugin05b::createModels() {
    ...
    model = this->m_modelWarehouse->createModel(
        ...
        glm::vec3(this->m_scene->m_xsize / 2.f, this->m_scene->m_zsize / 2.f, 1.f), glm::vec3(-90.f, 0.f, 0.f), glm::vec3(0.f, .1f, 0.f));
    ...
    for (uint32_t i = 0; i < Config::ENVIRONMENT_TREES; ++i) {
        ...
        float x = this->m_scene->m_xcenter, z = this->m_scene->m_zcenter;
        while (std::abs(this->m_scene->m_xcenter - x) < xRadius && std::abs(this->m_scene->m_zcenter - z) < zRadius) {
            x = AppUtils::getInstance()->randomNumber(this->m_scene->m_xmin + this->m_scene->m_xsize / 4.f, this->m_scene->m_xmax - this->m_scene->m_xsize / 4.f);
            z = AppUtils::getInstance()->randomNumber(this->m_scene->m_zmin + this->m_scene->m_zsize / 4.f, this->m_scene->m_zmax - this->m_scene->m_zsize / 4.f);
        }
    ...
    // cubes
    float zCoord = this->m_scene->m_zcenter + this->m_scene->m_zsize / 4.f + 3.f;
    ...
    model = this->m_modelWarehouse->createModel(
        ...
        glm::vec3(3.f), glm::vec3(0.f), glm::vec3(this->m_scene->m_xcenter - 11.5f, this->m_scene->m_ymin, zCoord - 1.5f));
    model->setTextureID(0); // texture unit 0; grass

    model = this->m_modelWarehouse->createModel(
        "04::cube02",
        "shader:phong_texture", "res:cube_texture", 0, 36,
        glm::vec3(3.f), glm::vec3(0.f), glm::vec3(this->m_scene->m_xcenter + 8.5f, this->m_scene->m_ymin, zCoord - 1.5f));
    ...
    model = this->m_modelWarehouse->createModel(
        ...
        glm::vec3(.5f, 1.5f, .5f), glm::vec3(0.f), glm::vec3(this->m_scene->m_xcenter - 10.f, 4.5f, zCoord));
    ...
    model = this->m_modelWarehouse->createModel(
        ...
        glm::vec3(1.5f), glm::vec3(0.f, 10.f, 0.f), glm::vec3(this->m_scene->m_xcenter, this->m_scene->m_ymin, this->m_scene->m_zcenter));
    ...
    model = this->m_modelWarehouse->createModel(
        ...
        glm::vec3(1.5f), glm::vec3(0.f, -20.f, 0.f), glm::vec3(this->m_scene->m_xcenter - 4.f, this->m_scene->m_ymin, this->m_scene->m_zcenter + 16.f));
    ...
    model = this->m_modelWarehouse->createModel(
        ...
        glm::vec3(10.f), glm::vec3(0.f), glm::vec3(this->m_scene->m_xcenter, 50.f, this->m_scene->m_zcenter));
