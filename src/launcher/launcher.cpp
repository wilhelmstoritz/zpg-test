...
int main(void) {
	...
	application->addScene(builder->createScene("scene::6", new SceneBuilderPlugin05a)); // task 05a; magic woods with textures; torches & grass
	application->addScene(builder->createScene("scene::7", new SceneBuilderPlugin05b)); // task 05b; magic woods with .obj models; trees, house, zombie & login
