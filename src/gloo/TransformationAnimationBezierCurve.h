...
private:
	...
	std::vector<float> m_binomialCoefficients; // precomputed binomial coefficients for n-th degree of the bezier curve
	std::vector<std::vector<float>> m_allBinomialCoefficients; // precomputed binomial coefficients for all degrees of the bezier curve
